...
const express = require('express');
const cors = require('cors');
const scanController = require('./src/controller/scanController');
const teamScanController = require('./src/controller/teamScanController');
const { PrismaClient } = require('@prisma/client');
...
// Routes for Scan
app.get('/api/scans', scanController.getAllScans);
app.post('/api/scans', scanController.createScan);
app.delete('/api/scans', scanController.deleteAllScans);

// Routes for TeamScan
app.get('/api/team-scans', teamScanController.getAllTeamScans);
app.post('/api/team-scans', teamScanController.createTeamScan);
app.delete('/api/team-scans', teamScanController.deleteAllTeamScans);
